...
$_['text_checkout_account']          = '第 2 步： 賬戶 &amp; 賬單詳細';
$_['text_checkout_payment_address']  = '第 2 步： 賬單地址';
...
$_['text_guest']                     = '直接結賬';
$_['text_register_account']          = '註冊一個賬戶以便您更快捷地購物， 查看訂單狀態， 查看采購的歷史記錄， 和更多的管理項目。';
...
$_['entry_shipping'] 	             = '我的配送地址和帳單地址相同。';
$_['entry_account']                  = '帳號:';
$_['entry_company_id']               = '公司註冊號:';
$_['entry_tax_id']                   = '公司稅號:';

// Error
$_['error_warning']                  = '在結算時出現了問題！ 如果此問題繼續存在請使用其它支付方式或<a href="%s">聯系我們</a>。';
...
$_['error_no_shipping']              = '無可用貨運方式。 請<a href="%s">聯系我們</a> 以獲取幫助！';
$_['error_payment']                  = '警告：請選擇一個支付方式！';
$_['error_no_payment']               = '警告：無可用支付方式。 請<a href="%s">聯系我們</a> 以獲取幫助！';
